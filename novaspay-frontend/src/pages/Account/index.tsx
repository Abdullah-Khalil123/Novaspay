            ...
            <tbody className="text-center text-text-primary">
              {isLoading ? (
                ...
                accounts.map((acc, idx) => (
                  ...
                  >
                    <td className="px-2 py-4 truncate">{acc.bankingName}</td>
                    <td className="px-2 py-4 truncate">{acc.currency}</td>
                    <td className="px-2 py-4 truncate">{acc.clientName}</td>
      ...
      {showDetails && (
        ...
        >
          ...
          <button
            ...
            className="px-4 py-1 bg-sidebar-child/90 text-white rounded-sm hover:bg-sidebar-child/85 cursor-pointer focus:outline-none focus:ring-2 focus:ring-sidebar-bg focus:ring-offset-2"
          >
            {t('History')}
          </button>
